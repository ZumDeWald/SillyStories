...
const favoriteGame = 'My favorite game has ${$num1} ${$noun1} s, ${$num2} ${$noun2} s, and a very ${$adj1} ${$noun3} ! You can play it with your ${$fam1} , or a friend. Don\'t ${$verb1} too close to the ${$adj2} ${$noun4} or you\'re ${$adv1} out!';
